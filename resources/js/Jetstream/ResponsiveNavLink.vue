...
<script>
    ...
    export default defineComponent({
        ...
        computed: {
            classes() {
                return this.active
                    ? 'block pl-3 pr-4 py-2 border-l-4 border-brand-primary-400 text-base font-medium text-brand-primary-700 bg-brand-primary-50 focus:outline-none focus:text-brand-primary-800 focus:bg-brand-primary-100 focus:border-brand-primary-700 transition'
