            ...
            <div class="mt-16">
                <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                    <div v-for="feature in features" :key="feature.name" class="relative">
                        <dt>
                            <div class="absolute flex items-center justify-center h-12 w-12 rounded-md bg-brand-primary-500 text-white">
...
<script>
import {AnnotationIcon, GlobeAltIcon, LightningBoltIcon, PlayIcon, ScaleIcon} from '@heroicons/vue/outline'
import LogoText from "@/Partials/LogoText";

export default {
    name: 'Stats2',
    components: {LogoText, PlayIcon},
    data() {
        return {
            features: [
                {
