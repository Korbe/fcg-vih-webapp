        ...
        <div class="max-w-sm mx-auto md:max-w-none">
          <div class="grid gap-12 md:grid-cols-3 md:col-gap-6 md:row-gap-8 items-start">
            ...
            <article class="flex flex-col h-full" data-aos="zoom-y-out">
              <header>
                <inertia-link href="/blog-post" class="block mb-6">
                ...
                <h3 class="text-xl font-bold leading-snug tracking-tight">
                  <inertia-link href="/blog-post" class="hover:underline">“How HubSpot saved 25% on developing costs by switching to Simple.”</inertia-link>
                </h3>
              </header>
            ...
            <article class="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
              <header>
                ...
                <h3 class="text-xl font-bold leading-snug tracking-tight">
                  <inertia-link href="/blog-post" class="hover:underline">“How Facebook brought 13% cost savings to their bottom line with Simple’s products.”</inertia-link>
                </h3>
              </header>
              <footer class="text-sm flex items-center mt-4">
                <div class="flex flex-shrink-0 mr-3">
            ...
            <article class="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
              <header>
                ...
                <h3 class="text-xl font-bold leading-snug tracking-tight">
                  <inertia-link href="/blog-post" class="hover:underline">“How Tinder grew 115% and saved 120 Hours each week by outsourcing to Simple.”</inertia-link>
                </h3>
              </header>
              <footer class="text-sm flex items-center mt-4">
                <div class="flex flex-shrink-0 mr-3">
