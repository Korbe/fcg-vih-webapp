                ...
                <div class="max-w-sm mx-auto md:max-w-none">
                    <div class="grid gap-12 md:grid-cols-3 md:col-gap-6 md:row-gap-8 items-start">
                        ...
                        <article class="flex flex-col h-full" data-aos="zoom-y-out">
                            <header>
                                <inertia-link class="block mb-6" href="/blog-post">
                                    <figure class="relative h-0 pb-9/16 overflow-hidden translate-z-0 rounded">
                                        <img alt="News 01" class="absolute inset-0 w-full h-full object-cover transform scale-105 hover:-translate-y-1 transition duration-700 ease-out"
                                             height="198" src="/images/news-01.jpg" width="352"/>
                                    </figure>
                                </inertia-link>
                                <div class="mb-3">
                                    <ul class="flex flex-wrap text-xs font-medium -m-1">
                                        <li class="m-1">
                                            <a class="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-blue-500 hover:bg-blue-600 transition duration-150 ease-in-out" href="#0">Case
                                                studies</a>
                                        </li>
                                        <li class="m-1">
                                ...
                                <h3 class="text-xl font-bold leading-snug tracking-tight">
                                    <inertia-link class="hover:underline" href="/blog-post">“How HubSpot saved 25% on developing costs by switching to Simple.”</inertia-link>
                                </h3>
                            </header>
                            <footer class="text-sm flex items-center mt-4">
                                <div class="flex flex-shrink-0 mr-3">
                                    <a class="relative" href="#0">
                                        <span aria-hidden="true" class="absolute inset-0 -m-px"><span class="absolute inset-0 -m-px bg-white rounded-full"></span></span>
                                        <img alt="Author 01" class="relative rounded-full" height="32" src="/images/news-author-01.jpg" width="32"/>
                                    </a>
                                </div>
                                <div>
                        ...
                        <article class="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="150">
                            <header>
                                <inertia-link class="block mb-6" href="/blog-post">
                                    <figure class="relative h-0 pb-9/16 overflow-hidden translate-z-0 rounded">
                                        <img alt="News 02"
                                             class="absolute inset-0 w-full h-full object-cover transform scale-105 translate-z-0 hover:-translate-y-1 transition duration-700 ease-out" height="198" src="/images/news-02.jpg" width="352"/>
                                    </figure>
                                </inertia-link>
                                <div class="mb-3">
                                    <ul class="flex flex-wrap text-xs font-medium -m-1">
                                ...
                                <h3 class="text-xl font-bold leading-snug tracking-tight">
                                    <inertia-link class="hover:underline" href="/blog-post">“How Facebook brought 13% cost savings to their bottom line with Simple’s products.”</inertia-link>
                                </h3>
                            </header>
                            <footer class="text-sm flex items-center mt-4">
                                <div class="flex flex-shrink-0 mr-3">
                                    <a class="relative -ml-2" href="#0">
                                        <span aria-hidden="true" class="absolute inset-0 -m-px"><span class="absolute inset-0 -m-px bg-white rounded-full"></span></span>
                                        <img alt="Author 02" class="relative rounded-full" height="32" src="/images/news-author-02.jpg" width="32"/>
                                    </a>
                                </div>
                                <div>
                                    <span class="text-gray-600">By </span>
                        ...
                        <article class="flex flex-col h-full" data-aos="zoom-y-out" data-aos-delay="300">
                            <header>
                                <inertia-link class="block mb-6" href="/blog-post">
                                    <figure class="relative h-0 pb-9/16 overflow-hidden translate-z-0 rounded">
                                        <img alt="News 03"
                                             class="absolute inset-0 w-full h-full object-cover transform scale-105 translate-z-0 hover:-translate-y-1 transition duration-700 ease-out" height="198" src="/images/news-03.jpg" width="352"/>
                                    </figure>
                                </inertia-link>
                                <div class="mb-3">
                                    <ul class="flex flex-wrap text-xs font-medium -m-1">
                                ...
                                <h3 class="text-xl font-bold leading-snug tracking-tight">
                                    <inertia-link class="hover:underline" href="/blog-post">“How Tinder grew 115% and saved 120 Hours each week by outsourcing to Simple.”</inertia-link>
                                </h3>
                            </header>
                            <footer class="text-sm flex items-center mt-4">
                                <div class="flex flex-shrink-0 mr-3">
