      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="text-center pb-12 md:pb-16">
          ...
          <div class="max-w-3xl mx-auto">
            <p class="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Herzlich Willkommen, wir sind eine Gruppe Christus-gläubiger Menschen. Es erwartet Sie ein buntes Gemisch von Menschen, die nie beisammen wären, wenn Sie nicht Christus kennengelernt hätten.</p>
