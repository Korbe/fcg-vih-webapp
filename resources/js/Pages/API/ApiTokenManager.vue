    ...
    <div>
        ...
        <jet-form-section @submitted="createApiToken">
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <jet-input id="name" v-model="createApiTokenForm.name" autofocus class="mt-1 block w-full" type="text"/>
        ...
        <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <jet-button :class="{ 'opacity-25': updateApiTokenForm.processing }" :disabled="updateApiTokenForm.processing" class="ml-2" @click="updateApiToken">
                    Save
                </jet-button>
            </template>
        </jet-dialog-modal>
        ...
        <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <jet-danger-button :class="{ 'opacity-25': deleteApiTokenForm.processing }" :disabled="deleteApiTokenForm.processing" class="ml-2" @click="deleteApiToken">
                    Delete
                </jet-danger-button>
            </template>
