                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <jet-input id="title" v-model="form.title" autocomplete="name" class="mt-1 block w-full" type="text"/>
                                    <jet-input-error :message="form.errors.title" class="mt-2"/>
                                </div>

                                <div class="col-span-6">
                                    <jet-label for="audio" value="Audio"/>
                                    <file-input v-model="form.audio" :error="form.errors.audio" accept="audio/mp3,audio/*;capture=microphone" class="" type="file"/>
