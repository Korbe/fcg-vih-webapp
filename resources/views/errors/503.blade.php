...
<head>
    ...
    <title>Site Maintenance - FCG Villach</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body>
<article class="text-center mx-auto max-w-3xl py-48">
    <img loading="lazy" class="h-48 mx-auto my-5" src="/images/fcg-villach-logo.png"/>
    ...
    <div>
        ...
        <p class="text-gray-500 mt-5">- Ihre Freie Christengemeinde in Villach</p>
    </div>
</article>
</body>
</html>
